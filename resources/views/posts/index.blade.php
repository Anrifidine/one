    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
      <div class="modal-content flex h-full">
        <div class="modal-body relative overflow-hidden">
          <img src="" alt="Full-size Image" class="img-fluid w-full h-full object-cover" id="fullImage">
  
          <div class="absolute inset-0 flex justify-between items-center z-10">
            <button type="button" class="btn btn-secondary px-4 py-2 rounded text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 hover:bg-indigo-500 h-full opacity-0" id="prevBtn">&lt; Previous</button>
            <button type="button" class="btn btn-primary px-4 py-2 rounded text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 hover:bg-blue-500 h-full opacity-0" id="nextBtn">Next &gt;</button>
          </div>
        </div>
      </div>
    </div>
